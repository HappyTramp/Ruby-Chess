    ...
    it 'happy path' do
      expect([std_tb, std_tb[3, 3]])
        .to contain_exact_positions(
          [3, 2], [3, 1], [3, 4], [3, 5], [3, 6], [2, 3], [1, 3],
          [4, 3], [5, 3], [6, 3], [4, 2], [5, 1], [2, 4], [1, 5],
          [2, 2], [1, 1], [4, 4], [5, 5], [6, 6]
        )
    end
